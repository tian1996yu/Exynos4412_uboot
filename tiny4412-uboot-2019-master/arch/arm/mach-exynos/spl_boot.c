...
void copy_uboot_to_ram(void)
{
	...
	case BOOT_MODE_SD:
		...
		//printf("offset==%x,size==%x,MMC_INDEX==%d\n",BL2_START_OFFSET,BL2_SIZE_BLOC_COUNT,MMC_INDEX);
	        printascii("BOOT_MODE_SD \n\r");
	        printhex8(BL2_START_OFFSET);
	        printascii("\n\r");
		printhex8(BL2_SIZE_BLOC_COUNT);
		printascii("\n\r");
		printhex8(MMC_INDEX);
		printascii("\n\r");
		break;
